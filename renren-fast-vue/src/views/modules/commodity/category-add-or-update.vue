<template>
  <el-dialog
    ...
    <el-form-item label="父分类 id" prop="parentId">
      <el-input v-model="dataForm.parentId" placeholder="父分类 id"></el-input>
    </el-form-item>
    <el-form-item label="层级" prop="catLevel">
      <el-input v-model="dataForm.catLevel" placeholder="层级"></el-input>
    </el-form-item>
    <el-form-item label="0 不显示，1 显示" prop="isShow">
      <el-input v-model="dataForm.isShow" placeholder="0 不显示，1 显示"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          parentId: [
            { required: true, message: '父分类 id不能为空', trigger: 'blur' }
          ],
          catLevel: [
            { required: true, message: '层级不能为空', trigger: 'blur' }
          ],
          isShow: [
            { required: true, message: '0 不显示，1 显示不能为空', trigger: 'blur' }
          ],
          sort: [
