...
<script>
  import AddOrUpdate from './sale_attr-add-or-update.vue'
  export default {
    data () {
      return {
        data: [],
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl(`/commodity/attr/sale/list/${this.dataList.categoryId ? this.dataList.categoryId : 0}`),
          method: 'get',
